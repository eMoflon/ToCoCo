...
static void _powerstats_outputsniffer(int mac_status) {
	unsigned long txtime = (unsigned long) packetbuf_attr(PACKETBUF_ATTR_TRANSMIT_TIME);
	unsigned long txpwr =  (unsigned long) packetbuf_attr(PACKETBUF_ATTR_RADIO_TXPOWER);
